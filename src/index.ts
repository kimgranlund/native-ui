...
export { NManipulateHandle } from './components/manipulate-handle/manipulate-handle-element.ts';
export type { ManipulateMode, ManipulatePlacement } from './components/manipulate-handle/manipulate-handle-element.ts';
