...
describe('n-textarea', () => {
  describe('registration', () => {
    it('is registered as a custom element', () => {
      expect(customElements.get('n-textarea')).toBeDefined();
    });
  });
  ...
  describe('native:input event', () => {
    it('dispatches native:input CustomEvent on native input event', () => {
      const el = createElement();
    ...
    it('native:input event carries value in detail', () => {
      const el = createElement();
      el.textContent = 'hello world';

      let detail: any;
      el.addEventListener('native:input', (e: Event) => {
  ...
  describe('native:change event', () => {
    it('dispatches native:change CustomEvent on blur', () => {
      const el = createElement();
    ...
    it('native:change event carries value in detail', () => {
      const el = createElement();
      el.textContent = 'committed text';

      let detail: any;
      el.addEventListener('native:change', (e: Event) => {
        detail = (e as CustomEvent).detail;
      });
  ...
  describe('maxlength validity (tooLong)', () => {
    ...
    it('n-input detail.value carries full value when exceeding maxlength', () => {
      const el = createElement();
