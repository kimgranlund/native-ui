...
describe('n-button', () => {
  it('is registered as a custom element', () => {
    expect(customElements.get('n-button')).toBeDefined();
  });
  ...
  it('submits form when type="submit" on native:press', () => {
    const form = document.createElement('form');
    document.body.appendChild(form);
  ...
  it('resets form when type="reset" on native:press', () => {
    const form = document.createElement('form');
    document.body.appendChild(form);
  ...
  it('does not act on native:press when disabled', () => {
    const form = document.createElement('form');
    document.body.appendChild(form);
