...
import { registerTrait, getTrait } from '../../../core/trait-registry.ts';
...
describe('ui-controller', () => {
  it('is registered as a custom element', () => {
    expect(customElements.get('ui-controller')).toBeDefined();
  });

  describe('wrapper mode (default)', () => {
    it('applies traits to first element child', () => {
      const ctrl = document.createElement('ui-controller');
