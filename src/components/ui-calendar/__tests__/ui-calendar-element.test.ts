...
describe('ui-calendar element', () => {
  it('is registered as a custom element', () => {
    expect(customElements.get('ui-calendar')).toBeDefined();
  });
...
describe('ui-calendar disabled state', () => {
...
describe('ui-calendar date selection', () => {
  it('dispatches ui-change on date click', () => {
    const el = createAt(2025, 2); // March 2025
    const handler = vi.fn();
  ...
  it('does not dispatch ui-change when clicking a disabled cell', () => {
...
describe('ui-calendar min/max constraints', () => {
...
describe('ui-calendar view navigation', () => {
...
describe('ui-calendar teardown / re-initialization', () => {
  ...
  it('keydown listener does not double-fire after re-init', () => {
    ...
    // Press Enter on a cell — should only dispatch one ui-change
    const handler = vi.fn();
    el.addEventListener('ui-change', handler);
...
describe('ui-calendar form integration', () => {
