 ...
 * @fires native:sort - Fired on sort toggle with `{ column }` detail
 */
export class NTableHeader extends NativeElement {
  ...
  #onClick = (): void => {
    ...
    this.dispatchEvent(new CustomEvent('native:sort', {
      bubbles: true,
      composed: true,
