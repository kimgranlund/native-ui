...
export interface ResizeOptions {
  ...
  /** When false, the controller fires events but does not set host.style.width/height. Default: true. */
  autoApply?: boolean;
}
