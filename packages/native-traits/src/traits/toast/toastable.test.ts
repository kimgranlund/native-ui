...
// n-toast lives in @nonoun/native-ui — register a minimal stub for testing
class NToastStub extends NativeElement {}
if (!customElements.get('n-toast')) {
  customElements.define('n-toast', NToastStub);
}
...
describe('Toastable', () => {
  // Requires real n-toast component from @nonoun/native-ui
  it.skip('creates an n-toast element in the DOM', () => {
    const el = create();
  ...
  // Requires real n-toast component from @nonoun/native-ui
  it.skip('includes a dismiss button by default', () => {
    const el = create();
  ...
  // Requires real n-toast component from @nonoun/native-ui
  it.skip('dismiss button click removes the toast', () => {
    const el = create();
