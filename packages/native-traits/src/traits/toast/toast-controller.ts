...
// NOTE: n-toast component must be registered by the consumer (lives in @nonoun/native-ui).
// Import '@nonoun/native-ui/register' or define n-toast before using ToastController.
