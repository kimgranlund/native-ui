...
const _basicLinkPaste = new LinkPasteController(basicWrapper, {
  input: basicTextarea,
});

basicWrapper.addEventListener('native:link-paste', (e: Event) => {
...
import { BacktickWrapController } from '../backtick-wrap/backtick-wrap-controller.ts';
...
const _comboBacktick = new BacktickWrapController(comboWrapper, {
  input: comboTextarea,
});

const _comboLinkPaste = new LinkPasteController(comboWrapper, {
  input: comboTextarea,
});
...
comboWrapper.addEventListener('native:link-paste', (e: Event) => {
  const detail = (e as CustomEvent).detail;
