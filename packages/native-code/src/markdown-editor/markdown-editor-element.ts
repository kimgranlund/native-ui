...
import { NativeElement, createDisabledEffect } from '@nonoun/native-core';
import { GatewayController, ResizeController, PresentController } from '@nonoun/native-traits';
...
import { EditorStore, DEFAULT_TOOLBAR } from './markdown-editor-store.ts';
import type { ViewMode } from './markdown-editor-store.ts';
 ...
 */
export class NMarkdownEditor extends NativeElement {
  ...
  #buildSurface(): void {
    const surface = document.createElement('n-pane');
    surface.setAttribute('data-panel', 'surface');
