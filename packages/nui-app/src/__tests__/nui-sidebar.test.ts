...
function create(): HTMLElement {
  const el = document.createElement('nui-sidebar');
...
describe('nui-sidebar', () => {
  it('is registered as a custom element', () => {
    expect(customElements.get('nui-sidebar')).toBeDefined();
  });
...
describe('nui-sidebar-item', () => {
  it('is registered as a custom element', () => {
    expect(customElements.get('nui-sidebar-item')).toBeDefined();
  });

  it('passive mode — no listbox child means no popover wired', () => {
    const el = document.createElement('nui-sidebar-item');
...
describe('nui-sidebar flyout coordinator', () => {
