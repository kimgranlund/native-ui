import { UIElement, createDisabledEffect, prop, syncProp, ListNavigateController } from '@nonoun/native-ui';
 ...
 */
export class NuiSidebarNav extends UIElement {
  ...
  setup(): void {
    ...
    if (__DEV__) {
      this.deferChildren(() => {
        if (!this.querySelector('nui-sidebar-nav-item')) console.warn('[nui-sidebar-nav] No <nui-sidebar-nav-item> descendants found.');
      });
    }
  }
